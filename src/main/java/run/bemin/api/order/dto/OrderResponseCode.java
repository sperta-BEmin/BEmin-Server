...
public enum OrderResponseCode {
  ...
  ORDER_DELETED(HttpStatus.OK, "ORS004", "주문이 삭제되었습니다"),
  ORDER_FETCHED(HttpStatus.OK, "ORS005", "주문을 성공적으로 조회했습니다."),
  ORDER_DETAIL_FETCHED(HttpStatus.OK, "ORS006", "주문상세를 성공적으로 조회했습니다.");
